...
# to launch the program in temrinal : streamlit run technical.py
# this will load a web page in local browser
#
#  /opt/anaconda3/bin/streamlit run technical_1.py
#
